...
Esta é uma solução para o desafio do Frontend Mentor [Article-preview-component-master challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/article-preview-component-dYBN_pYFT/hub). Os desafios do Frontend Mentor ajudam a melhorar minhas habilidades de codificação criando projetos realistas.
...
![](./public/captura-de-tela.gif)

### Links

- URL da solução: [Github](https://github.com/BraynnerM/article-preview-component-master)
-  URL do site no Github Pages: [Results summary component](https://article-preview-component-master-three-beta.vercel.app/)
